...
typedef struct HashTable {
    ...
    char** key_order;    // New: Array to track keys in insertion order
    size_t key_count;    // New: Number of keys in key_order
    size_t key_capacity; // New: Allocated size of key_order
} HashTable;
